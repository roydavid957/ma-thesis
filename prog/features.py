...
class Embeddings(TransformerMixin):
    ...
    def __init__(self, word_embeds, glove_embeds, nrange, pte, pool='average'):
        '''
    ...
    def transform(self, X, **transform_params):
        ...
        '''
        return [self.get_sent_embedding(sent, self.word_embeds, self.glove_embeds, self.nrange, self.pte, self.pool_method) for sent in X]

    def fit(self, X, y=None, **fit_params):
        return self

    def get_sent_embedding(self, sentence, word_embeds, glove_embeds, nrange, pte, pool):
        '''
